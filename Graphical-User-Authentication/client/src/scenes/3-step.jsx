    ...
    useEffect(() => {
        async function getUser() {
            try {
                ...
                if (res.data.payload.imagePass !== imagePassword) {
                    toast.error("Image Password doesnot match..!", {
                        id: 'image1'
                    })
                    window.location.reload();
                } else if (res.data.payload.imagePass === imagePassword) {
                    newLogin()
